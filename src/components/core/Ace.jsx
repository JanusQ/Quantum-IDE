...
const Ace = (props) => {
	...
	// 多个选择框
	const { Option } = Select
	const optionList = ['case 4',  'Quantum Fourier Transform', 'user_study', 'case 3', 'into_evolution','case 1',  'case 2', 'bell_state', 'all gates', 'adding two integers', 'ex7-7', 'ex7-1', 'about:black'] // case的列表，public\js中需要存对应的文件
