	...
	const userInfoForm = () => {
		return (
			...
			>
				...
				<Form.Item label='手机号码：' style={{ display: isEdit ? 'none' : 'flex' }}>
				...
				<Form.Item label='电子邮箱：' style={{ display: isEdit ? 'none' : 'flex' }}>
				...
				<Form.Item label='单位名称：' style={{ display: isEdit ? 'none' : 'flex' }}>
				...
				<Form.Item label='单位类型：' style={{ display: isEdit ? 'none' : 'flex' }}>
				...
				<Form.Item label='单位地址：' style={{ display: isEdit ? 'none' : 'flex' }}>
