...
function App() {
	...
	const runProgram = (sample) => {
        ...
        'rx','ry','rz','u1','u2','u3','swap','iswap','srswap','xy','ms','yy','zz','had','hadamard','not', 'reset','write','cnot','phase','startlabel','endlabel','ccnot','ncnot'];
		var cx,cy,cz,ch,csrn,cr2,cr4,cr8,crx,cry,crz,cu1,cu2,cu3,cs,ct,csdg,ctdg,ccx,id,x,y,z,h,srn,srndg,r2,r4,r8,s,t,sdg,
		tdg,rx,ry,rz,u1,u2,u3,swap,iswap,srswap,xy,ms,yy,zz,had,hadamard,not,reset,write,cnot,phase,startlabel,endlabel,ccnot,ncnot;
		//let gates =['had']
